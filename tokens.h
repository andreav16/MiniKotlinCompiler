...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    KW_READFLOAT = 292,            /* KW_READFLOAT  */
    KW_READINT = 293,              /* KW_READINT  */
    KW_PRINT = 294,                /* KW_PRINT  */
    KW_MAIN = 295,                 /* KW_MAIN  */
    KW_ARGS = 296,                 /* KW_ARGS  */
    TK_ID = 297,                   /* TK_ID  */
    TK_LIT_STRING = 298,           /* TK_LIT_STRING  */
    TK_LINE_COMMENT = 299,         /* TK_LINE_COMMENT  */
    TK_BLOCK_COMMENT = 300,        /* TK_BLOCK_COMMENT  */
    TK_LIT_FLOAT = 301,            /* TK_LIT_FLOAT  */
    TK_LIT_INT = 302,              /* TK_LIT_INT  */
    TK_LIT_CHAR = 303,             /* TK_LIT_CHAR  */
    KW_TRUE = 304,                 /* KW_TRUE  */
