...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    KW_ARRAYOF = 284,              /* KW_ARRAYOF  */
    KW_ARRAY = 285,                /* KW_ARRAY  */
    KW_WHEN = 286,                 /* KW_WHEN  */
    KW_IS = 287,                   /* KW_IS  */
    KW_NULL = 288,                 /* KW_NULL  */
    KW_VAL = 289,                  /* KW_VAL  */
    KW_WHILE = 290,                /* KW_WHILE  */
    KW_CONST = 291,                /* KW_CONST  */
    KW_INT = 292,                  /* KW_INT  */
    KW_FLOAT = 293,                /* KW_FLOAT  */
    KW_CHAR = 294,                 /* KW_CHAR  */
    KW_BOOLEAN = 295,              /* KW_BOOLEAN  */
    KW_STRING = 296,               /* KW_STRING  */
    KW_UNTIL = 297,                /* KW_UNTIL  */
    KW_PRINTLN = 298,              /* KW_PRINTLN  */
    KW_READLINE = 299,             /* KW_READLINE  */
    KW_PRINT = 300,                /* KW_PRINT  */
    TK_LIT_CHAR = 301,             /* TK_LIT_CHAR  */
    TK_LIT_STRING = 302,           /* TK_LIT_STRING  */
    KW_MAIN = 303,                 /* KW_MAIN  */
    KW_ARGS = 304                  /* KW_ARGS  */
  };
